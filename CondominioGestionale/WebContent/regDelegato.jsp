...
<link rel="stylesheet" href="registrazioneDel.css">
<link
		...
		<form action="Servlet?op=regdel" method="post" name="invio">
			...
			<p>
				<i class="fa fa-user-circle" aria-hidden="true"></i> Delegato di : <input
					type="text" name="nominativo" placeholder="Nome e Cognome" required
					autocomplete="off"> <i class="fa fa-address-card-o"
					aria-hidden="true"></i> Palazzo <input type="text"
					name="id_palazzina" placeholder="Nome palazzina" required
					autocomplete="off"> <input class="btn" type="submit"
					value="Registrati" onclick="valida()"> <br /> <input
					class="btn" type="reset" value="Reset"> <br />
			<p>
	...
	<script type="text/javascript">
		function valida() {
			...
			if (file2 == "") {
				...
				document.invio.action = "Servlet?op=regdel";
